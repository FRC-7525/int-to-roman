...
class ConverterTest {
    ...
    @Test
    public void shouldConvertStrange() throws Exception {
        assertEquals("LIV", converter.convert(54));
        assertEquals("LXXXII", converter.convert(82));
        assertEquals("CCCXLIV", converter.convert(344));
        assertEquals("DCCLXII", converter.convert(762));
        assertEquals("CXVII", converter.convert(117));
        assertEquals("DCCCLXXXII", converter.convert(882));
        assertEquals("MMMMMMMMCCCXLVIII", converter.convert(8348));
    }
    ...
    @Test
    public void shouldNotBeHardcoded() throws Exception {
        Random rand = new Random();   
        String roman = converter.convert(rand.nextInt(500) + 1);
        assertTrue(roman.length() >= 1);
    }
}